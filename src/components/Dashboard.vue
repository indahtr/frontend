  ...
  <div>
    ...
    <div class="table-responsive shadow p-3 mb-5 bg-white rounded" style="display: flex; flex-direction: column; align-items: center; justify-content: center;">
      ...
      <p style="text-align: center; margin-bottom: 20px; font-size: 18px; color: #555;">
        Selamat datang di Dashboard Tata Usaha. Di sini Anda dapat mengelola Kartu Rencana Studi (KRS) mahasiswa.
        Gunakan menu di atas untuk navigasi ke berbagai fitur, termasuk pengelolaan data mahasiswa, matakuliah, dan KRS.
      </p>
